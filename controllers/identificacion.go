...
type IdentificacionController struct {
	beego.Controller
}

// URLMapping ...
func (c *IdentificacionController) URLMapping() {
...
// @Param	body		body 	models.Identificacion	true		"body for Identificacion content"
// @Success 201 {int} models.Identificacion
// @Failure 403 body is empty
// @router / [post]
func (c *IdentificacionController) Post() {
	var v models.Identificacion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddIdentificacion(&v); err == nil {
...
// @Success 200 {object} models.Identificacion
// @Failure 403 :id is empty
// @router /:id [get]
func (c *IdentificacionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetIdentificacionById(id)
	if err != nil {
		c.Data["json"] = models.Alert{Type: "error", Code: "E_400", Body: err.Error()}
	} else {
		c.Data["json"] = v
...
// @Failure 403
// @router / [get]
func (c *IdentificacionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @router /:id [put]
func (c *IdentificacionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Identificacion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *IdentificacionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteIdentificacion(id); err == nil {
		c.Data["json"] = models.Alert{Type: "success", Code: "200", Body: "OK"}
	} else {
		c.Data["json"] = models.Alert{Type: "error", Code: "E_400", Body: err.Error()}
	}
